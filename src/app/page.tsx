...
export default function Home() {
  ...
  useEffect(() => {
    ...
    [aboutRef, directorRef, projectRef, boardRef, financialRef, achievementRef, galleryRef, contactRef].forEach(ref => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      */}
      ...
      <div id="director-message" ref={directorRef} className="slide-in-section">
        <ManagingDirector />
      </div>
